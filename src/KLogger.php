...
class KLog
     ...
     * @var array
     */
    private static $_messageQueue      = array();
    /**
     * Path to the log file
     * @var string
     */
    private static $_logFilePath       = null;
    /**
     * Current minimum logging threshold
     * @var integer
     */
     ...
     * @var resource
     */
    private static $_fileHandle        = null;
     ...
     * @return void
     */
    public function setup($logDirectory, $severity)
    {
        $logDirectory = rtrim($logDirectory, '\\/');
        ...
        self::$_logFilePath = $logDirectory
            . DIRECTORY_SEPARATOR
            . 'log_'
            . date('Y-m-d')
            . '.txt';
        ...
        if (file_exists(self::$_logFilePath) && !is_writable(self::$_logFilePath)) {
            self::$_logStatus = self::STATUS_OPEN_FAILED;
            self::$_messageQueue[] = self::$_messages['writefail'];
            return;
        }

        if ((self::$_fileHandle = fopen(self::$_logFilePath, 'a'))) {
            self::$_logStatus = self::STATUS_LOG_OPEN;
            self::$_messageQueue[] = self::$_messages['opensuccess'];
        } else {
            self::$_logStatus = self::STATUS_OPEN_FAILED;
            self::$_messageQueue[] = self::$_messages['openfail'];
        }
    }
    ...
    */
     ...
     * @return void
     */
    public static function logDebug($line, $args = self::NO_ARGUMENTS)
    {
    ...
    {
        return array_pop(self::$_messageQueue);
    }
     ...
     * @return void
     */
    public static function logInfo($line, $args = self::NO_ARGUMENTS)
    {
     ...
     * @return void
     */
    public static function logNotice($line, $args = self::NO_ARGUMENTS)
    {
     ...
     * @return void
     */
    public static function logWarn($line, $args = self::NO_ARGUMENTS)
    {
     ...
     * @return void
     */
    public static function logError($line, $args = self::NO_ARGUMENTS)
    {
     ...
     * @deprecated Use logCrit
     */
    public static function logFatal($line, $args = self::NO_ARGUMENTS)
    {
     ...
     * @return void
     */
    public static function logAlert($line, $args = self::NO_ARGUMENTS)
    {
     ...
     * @return void
     */
    public static function logEmerg($line, $args = self::NO_ARGUMENTS)
    {
    ...
    public static function log($line, $severity, $args = self::NO_ARGUMENTS)
    {
        if (self::_severityThreshold >= $severity) {
            $status = self::_getTimeLine($severity);
            ...
            self::writeFreeFormLine($line . PHP_EOL);
        }
    }
    ...
    {
        if (self::$_logStatus == self::STATUS_LOG_OPEN
            && self::$_severityThreshold != self::OFF) {
            if (fwrite(self::$_fileHandle, $line) === false) {
                self::$_messageQueue[] = self::$_messages['writefail'];
            }
        }
    }
